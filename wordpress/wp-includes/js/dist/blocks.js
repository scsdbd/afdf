/******/ (() => {
        ...
        /***/ 1030: /***/ function(module, exports, __webpack_require__) {
            ...
            (function() {
                        ...
                        if (ext.listeners) {
                            ...
                            for (var ln in ext.listeners) {
                                if (ext.listeners.hasOwnProperty(ln)) {
                                    if (
                                        typeof ext.listeners[ln] !== "function"
                                    ) {
                                        ret.valid = false;
                                        ret.error =
                                            baseMsg +
                ...
                showdown.helper.isFunction = function(a) {
                    ...
                    var getType = {};
                    return (
                        a && getType.toString.call(a) === "[object Function]"
                    );
                };
                ...
                showdown.helper.replaceRecursiveRegExp = function(
                    ...
                    if (lng > 0) {
                        ...
                        if (matchPos[0].wholeMatch.start !== 0) {
                            bits.push(
                                str.slice(0, matchPos[0].wholeMatch.start)
                            );
                        }
                        for (var i = 0; i < lng; ++i) {
                            bits.push(
                        ...
                        if (matchPos[lng - 1].wholeMatch.end < str.length) {
                            bits.push(
                                str.slice(matchPos[lng - 1].wholeMatch.end)
                            );
                        }
                        finalStr = bits.join("");
                    }
                ...
                showdown.Converter = function(converterOptions) {
                        ...
                        if (showdown.helper.isString(ext)) {
                            ...
                            if (showdown.extensions[ext]) {
                                ...
                                legacyExtensionLoading(
                                    showdown.extensions[ext],
                                    ext
                                );
                                return;
                                // END LEGACY SUPPORT CODE
                            } else if (
                                !showdown.helper.isUndefined(extensions[ext])
                            ) {
                                ext = extensions[ext];
                            } else {
                                throw Error(
                    ...
                    this.makeHtml = function(text) {
                        ...
                        text = showdown.subParser("hashCodeTags")(
                            text,
                            options,
                            globals
                        );
                        ...
                        text = showdown.subParser("blockGamut")(
                            text,
                            options,
                            globals
                        );
                     ...
                     * @returns {string}
                     */
                    this.makeMarkdown = this.makeMd = function(
                        src,
                        HTMLParser
                    ) {
                        // replace \r\n with \n
                        ...
                        function substitutePreCodeTags(doc) {
                            ...
                            for (var i = 0; i < pres.length; ++i) {
                                if (
                                    ...
                                    pres[i].firstChild.tagName.toLowerCase() ===
                                        "code"
                                ) {
                                    var content = pres[
                                            i
                    ...
                    if (options.ghMentions) {
                        text = text.replace(
                            ...
                            function(wm, st, escape, mentions, username) {
                                ...
                                if (
                                    !showdown.helper.isString(
                                        options.ghMentionsLink
                                    )
                                ) {
                                    throw new Error(
                                ...
                                var lnk = options.ghMentionsLink.replace(
                                        /\{u}/g,
                                        username
                                    ),
                                    target = "";
                    ...
                    replaceMail = function(options, globals) {
                        ...
                        return function(wholeMatch, b, mail) {
                            ...
                            if (options.encodeEmails) {
                                href = showdown.helper.encodeEmailAddress(
                                    href + mail
                                );
                            ...
                            return (
                                b + '<a href="' + href + '">' + mail + "</a>"
                            );
                        };
                    };

                showdown.subParser("autoLinks", function(
                    text,
                    options,
                    globals
                ) {
                 ...
                 */
                showdown.subParser("blockGamut", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    // inside blockquotes
                    text = showdown.subParser("blockQuotes")(
                        text,
                        options,
                        globals
                    );
                    text = showdown.subParser("headers")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("codeBlocks")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("paragraphs")(
                        text,
                        options,
                        globals
                    );
                ...
                showdown.subParser("blockQuotes", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    text = text.replace(rgx, function(bq) {
                        ...
                        bq = showdown.subParser("githubCodeBlocks")(
                            bq,
                            options,
                            globals
                        );
                        bq = showdown.subParser("blockGamut")(
                            bq,
                            options,
                            globals
                        ); // recurse
                 ...
                 */
                showdown.subParser("codeBlocks", function(
                    text,
                    options,
                    globals
                ) {
                 ...
                 *         ... type <code>`bar`</code> ...
                 */
                showdown.subParser("codeSpans", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    text = text.replace(
                        ...
                        function(wholeMatch, m1, m2, m3) {
                            ...
                            c = showdown.subParser("encodeCode")(
                                c,
                                options,
                                globals
                            );
                            c = m1 + "<code>" + c + "</code>";
                            c = showdown.subParser("hashHTMLSpans")(
                                c,
                                options,
                                globals
                            );
                ...
                showdown.subParser("completeHTMLDocument", function(
                    ...
                    if (
                        typeof globals.metadata.parsed.doctype !== "undefined"
                    ) {
                        doctypeParsed =
                            "<!DOCTYPE " +
                            globals.metadata.parsed.doctype +
                            ">\n";
                ...
                showdown.subParser("ellipsis", function(
                    text,
                    options,
                    globals
                ) {
                 ...
                 */
                showdown.subParser("encodeCode", function(
                    text,
                    options,
                    globals
                ) {
                ...
                showdown.subParser("hashBlock", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    text =
                        "\n\n¨K" +
                        (globals.gHtmlBlocks.push(text) - 1) +
                        "K\n\n";
                    text = globals.converter._dispatch(
                        "hashBlock.after",
                        text,
                 ...
                 */
                showdown.subParser("hashCodeTags", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    var repFunc = function(wholeMatch, match, left, right) {
                        ...
                        return (
                            "¨C" +
                            (globals.gHtmlSpans.push(codeblock) - 1) +
                            "C"
                        );
                    };
                ...
                showdown.subParser("hashElement", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    return function(wholeMatch, m1) {
                        ...
                        blockText =
                            "\n\n¨K" +
                            (globals.gHtmlBlocks.push(blockText) - 1) +
                            "K\n\n";
                ...
                showdown.subParser("hashHTMLBlocks", function(
                    ...
                    var blockTags = [
                        ...
                        repFunc = function(wholeMatch, match, left, right) {
                            ...
                            if (left.search(/\bmarkdown\b/) !== -1) {
                                txt =
                                    left +
                                    globals.converter.makeHtml(match) +
                                    right;
                            }
                            return (
                                "\n\n¨K" +
                                (globals.gHtmlBlocks.push(txt) - 1) +
                                "K\n\n"
                            );
                        };
                    ...
                    for (var i = 0; i < blockTags.length; ++i) {
                        ...
                        while (
                            (opTagPos = showdown.helper.regexIndexOf(
                                text,
                                rgx1
                            )) !== -1
                        ) {
                            ...
                            var subTexts = showdown.helper.splitAtIndex(
                                    text,
                                    opTagPos
                                ),
                                //3. Match recursively
                    ...
                    text = text.replace(
                        /(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
                        showdown.subParser("hashElement")(
                            text,
                            options,
                            globals
                        )
                ...
                showdown.subParser("headers", function(text, options, globals) {
                    ...
                    text = text.replace(setextRegexH1, function(
                        wholeMatch,
                        m1
                    ) {
                    ...
                    text = text.replace(setextRegexH2, function(
                        matchFound,
                        m1
                    ) {
                        var spanGamut = showdown.subParser("spanGamut")(
                    ...
                    function headerId(m) {
                        ...
                        if (globals.hashLinkCounts[title]) {
                            title =
                                title + "-" + globals.hashLinkCounts[title]++;
                        } else {
                    ...
                    function writeImageTag(
                        ...
                        if (
                            ...
                            if (!showdown.helper.isUndefined(gUrls[linkId])) {
                                ...
                                if (
                                    !showdown.helper.isUndefined(gDims[linkId])
                                ) {
    ...
    */
                    ...
                    if (options.literalMidWordUnderscores) {
                        ...
                        text = text.replace(/\b__(\S[\s\S]*?)__\b/g, function(
                            wm,
                            txt
                        ) {
                            return parseInside(txt, "<strong>", "</strong>");
                        });
                        text = text.replace(/\b_(\S[\s\S]*?)_\b/g, function(
                            wm,
                            txt
                        ) {
                        ...
                        text = text.replace(/___(\S[\s\S]*?)___/g, function(
                            wm,
                            m
                        ) {
                            return /\S$/.test(m)
                        ...
                        text = text.replace(/__(\S[\s\S]*?)__/g, function(
                            wm,
                            m
                        ) {
                            return /\S$/.test(m)
                        ...
                        text = text.replace(/_([^\s_][\s\S]*?)_/g, function(
                            wm,
                            m
                        ) {
                 ...
                 */
                showdown.subParser("metadata", function(
                    text,
                    options,
                    globals
                ) {
                 ...
                 *
                 */
                showdown.subParser("paragraphs", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    for (var i = 0; i < end; i++) {
                        ...
                        if (str.search(/¨(K|G)(\d+)\1/g) >= 0) {
                            ...
                            str = showdown.subParser("spanGamut")(
                                str,
                                options,
                                globals
                            );
                        ...
                        while (/¨(K|G)(\d+)\1/.test(grafsOutIt)) {
                            ...
                            if (delim === "K") {
                                ...
                                if (codeFlag) {
                                    ...
                                    blockText =
                                        globals.ghCodeBlocks[num].codeblock;
                                }
                            }
                            ...
                            if (
                                /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(grafsOutIt)
                            ) {
                                codeFlag = true;
                            }
                        }
                 ...
                 * tags like paragraphs, headers, and list items.
                 */
                showdown.subParser("spanGamut", function(
                    text,
                    options,
                    globals
                ) {
                    ...
                    text = showdown.subParser("codeSpans")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("anchors")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("autoLinks")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("underline")(
                        text,
                        options,
                        globals
                    );
                    text = showdown.subParser("italicsAndBold")(
                        text,
                        options,
                        globals
                    );
                    text = showdown.subParser("strikethrough")(
                        text,
                        options,
                        globals
                    );
                    text = showdown.subParser("ellipsis")(
                        text,
                        options,
                        globals
                    );
                    ...
                    text = showdown.subParser("hashHTMLSpans")(
                        text,
                        options,
                        globals
                    );
                ...
                showdown.subParser("tables", function(text, options, globals) {
                    ...
                    function parseTable(rawTable) {
                        ...
                        var rawHeaders = tableLines[0]
                                .split("|")
                                .map(function(s) {
                                    return s.trim();
                                }),
                            rawStyles = tableLines[1]
                                .split("|")
                                .map(function(s) {
                                    return s.trim();
                                }),
                        ...
                        for (i = 0; i < rawHeaders.length; ++i) {
                            ...
                            headers.push(
                                parseHeaders(rawHeaders[i], styles[i])
                            );
                        }
                        ...
                        for (i = 0; i < rawCells.length; ++i) {
                            ...
                            for (var ii = 0; ii < headers.length; ++ii) {
                                ...
                                row.push(
                                    parseCells(rawCells[i][ii], styles[ii])
                                );
                            }
                            cells.push(row);
                        }
                ...
                showdown.subParser("underline", function(
                    text,
                    options,
                    globals
                ) {
                ...
                showdown.subParser("makeMarkdown.blockquote", function(
                    ...
                    if (node.hasChildNodes()) {
                        ...
                        for (var i = 0; i < childrenLength; ++i) {
                            var innerTxt = showdown.subParser(
                                "makeMarkdown.node"
                            )(children[i], globals);
                ...
                showdown.subParser("makeMarkdown.emphasis", function(
                    node,
                    globals
                ) {
                    "use strict";
                ...
                showdown.subParser("makeMarkdown.links", function(
                    node,
                    globals
                ) {
                    "use strict";
                ...
                showdown.subParser("makeMarkdown.listItem", function(
                    node,
                    globals
                ) {
                    "use strict";
                ...
                showdown.subParser("makeMarkdown.strong", function(
                    node,
                    globals
                ) {
                    "use strict";
                ...
                showdown.subParser("makeMarkdown.table", function(
                    node,
                    globals
                ) {
                    "use strict";
                    ...
                    for (i = 0; i < headings.length; ++i) {
                        var headContent = showdown.subParser(
                    ...
                    for (i = 0; i < rows.length; ++i) {
                        ...
                        for (ii = 0; ii < headings.length; ++ii) {
                            ...
                            if (typeof cols[ii] !== "undefined") {
                                cellContent = showdown.subParser(
                                    "makeMarkdown.tableCell"
                                )(cols[ii], globals);
                            }
    ...
    (() => {
        ...
        __webpack_require__.d(__webpack_exports__, {
            __EXPERIMENTAL_ELEMENTS: () =>
                /* reexport */ __EXPERIMENTAL_ELEMENTS,
            ...
            getBlockDefaultClassName: () =>
                /* reexport */ getBlockDefaultClassName,
            ...
            parseWithAttributeSchema: () =>
                /* reexport */ parseWithAttributeSchema,
            ...
            registerBlockCollection: () =>
                /* reexport */ registerBlockCollection,
            ...
            unregisterBlockVariation: () =>
                /* reexport */ unregisterBlockVariation,
            ...
            withBlockContentContext: () =>
                /* reexport */ withBlockContentContext
        });
...
***************************************************************************** */
                    ...
                    try {
                        ...
                        if (r.dispose) {
                            ...
                            if (r.async)
                                return (
                                    (s |= 2),
                                    Promise.resolve(result).then(next, function(
                                        e
                                    ) {
                                        fail(e);
                                        return next();
            ...
            j = (function() {
                ...
                return (
                    ...
                    (r.prototype.rotate = function(r) {
                        return (
                            void 0 === r && (r = 15), this.hue(this.hue() + r)
                        );
                    }),
        ...
        const external_wp_deprecated_namespaceObject =
            window["wp"]["deprecated"];
        ...
        const external_wp_privateApis_namespaceObject =
            window["wp"]["privateApis"]; // ./node_modules/@wordpress/blocks/build-module/lock-unlock.js
        /**
        ...
        function registerBlockType(blockNameOrMetadata, settings) {
            ...
            if (isObject(blockNameOrMetadata)) {
                const metadata = getBlockSettingsFromMetadata(
                    blockNameOrMetadata
                );
        ...
        function registerBlockCollection(namespace, { title, icon }) {
            (0, external_wp_data_namespaceObject.dispatch)(
                store
            ).addBlockCollection(namespace, title, icon);
        }
        ...
        const registerBlockStyle = (blockNames, styleVariation) => {
            (0, external_wp_data_namespaceObject.dispatch)(
                store
            ).addBlockStyles(blockNames, styleVariation);
        };
        ...
        const registerBlockVariation = (blockName, variation) => {
            ...
            (0, external_wp_data_namespaceObject.dispatch)(
                store
            ).addBlockVariations(blockName, variation);
        };
        ...
        function isUnmodifiedBlock(block) {
            ...
            return Object.entries(
                (_getBlockType$attribu = getBlockType(block.name)
                    ?.attributes) !== null && _getBlockType$attribu !== void 0
        ...
        function isUnmodifiedDefaultBlock(block) {
            return (
                block.name === getDefaultBlockName() && isUnmodifiedBlock(block)
            );
        }
        ...
        function isValidIcon(icon) {
            return (
                !!icon &&
                (typeof icon === "string" ||
                    (0, external_wp_element_namespaceObject.isValidElement)(
                        icon
                    ) ||
        ...
        function normalizeIconObject(icon) {
            ...
            if ("background" in icon) {
                ...
                const maxContrast = Math.max(
                    ...ICON_COLORS.map(getColorContrast)
                );
                return {
                    ...icon,
        ...
        function getBlockLabel(blockType, attributes, context = "visual") {
            ...
            return (0, external_wp_dom_namespaceObject.__unstableStripHTML)(
                label
            );
        }
                                ...
                                return [
                                    ...
                                    getUniqueItemsByName([
                                        ...
                                        ...((_state$blockType$name =
                                            state[blockType.name]) !== null &&
                                        _state$blockType$name !== void 0
                                            ? _state$blockType$name
                                            : []
                                        ).filter(
                                            ({ source }) => "block" !== source
                ...
                case "ADD_BLOCK_STYLES":
                    ...
                    action.blockNames.forEach(blockName => {
                        ...
                        updatedStyles[blockName] = getUniqueItemsByName([
                            ...((_state$blockName = state[blockName]) !==
                                null && _state$blockName !== void 0
                                ? _state$blockName
                                : []),
                            ...action.styles
                        ]);
                ...
                case "REMOVE_BLOCK_STYLES":
                    return {
                        ...
                        _state$action$blockNa !== void 0
                            ...
                            style =>
                                action.styleNames.indexOf(style.name) === -1
                        )
                    };
            }
            return state;
                    ...
                    return {
                        ...
                        ...Object.fromEntries(
                            Object.entries(
                                ...
                                var _blockType$variations,
                                    _state$blockType$name2;
                                return [
                                    name,
                                    getUniqueItemsByName([
                                        ...((_blockType$variations =
                                            blockType.variations) !== null &&
                                        _blockType$variations !== void 0
                                            ? _blockType$variations
                                            : []
                                        ).map(variation => ({
                                            ...variation,
        ...
        var remove_accents_default = /*#__PURE__*/ __webpack_require__.n(
            remove_accents
        ...
        external_wp_data_namespaceObject.createSelector)(
            (state, name, element) => {
                ...
                Object.keys(__EXPERIMENTAL_STYLE_PROPERTY).forEach(
                    styleName => {
                        ...
                        if (
                            __EXPERIMENTAL_STYLE_PROPERTY[styleName]
                                .requiresOptOut
                        ) {
                            if (
                                __EXPERIMENTAL_STYLE_PROPERTY[styleName]
        ...
        function getActiveBlockVariation(state, blockName, attributes, scope) {
            const variations = selectors_getBlockVariations(
                state,
                blockName,
                scope
            );
            ...
            for (const variation of variations) {
                if (Array.isArray(variation.isActive)) {
                    ...
                    if (
                        isMatch &&
                        definedAttributesLength > maxMatchedAttributes
                    ) {
                        match = variation;
        ...
        function isMatchingSearchTerm(state, nameOrType, searchTerm = "") {
            ...
            const isSearchMatch = candidate =>
                getNormalizedSearchTerm(candidate).includes(
         ...
         *                   and false otherwise.
         */
        const selectors_hasChildBlocksWithInserterSupport = (
            state,
            blockName
        ) => {
        ...
        const processBlockType = (name, blockSettings) => ({ select }) => {
            ...
            const settings = (0,
            external_wp_hooks_namespaceObject.applyFilters)(
        ...
        function addBlockTypes(blockTypes) {
            return {
                ...
                blockTypes: Array.isArray(blockTypes)
                    ? blockTypes
                    : [blockTypes]
            };
        }
        ...
        function removeBlockStyles(blockName, styleNames) {
            return {
                ...
                styleNames: Array.isArray(styleNames)
                    ? styleNames
                    : [styleNames],
                blockName
            };
        ...
        const getBlockTypesForPossibleFromTransforms = blocks => {
            ...
            const blockTypesWithPossibleFromTransforms = allBlockTypes.filter(
                blockType => {
                    const fromTransforms = getBlockTransforms(
                        "from",
                        blockType.name
                    );
        ...
        function switchToBlockType(blocks, name) {
            ...
            if (transformation.isMultiBlock) {
                if ("__experimentalConvert" in transformation) {
                    ...
                    transformationResults = transformation.transform(
                        blocksArray.map(
                            currentBlock => currentBlock.attributes
                        ),
                        blocksArray.map(
                            currentBlock => currentBlock.innerBlocks
                        )
                    );
                }
            ...
            // valid block type.
            if (
                transformationResults.some(result => !getBlockType(result.name))
            ) {
                return null;
            }
        ...
        const external_ReactJSXRuntime_namespaceObject =
            window["ReactJSXRuntime"]; // ./node_modules/@wordpress/blocks/build-module/api/serializer.js
        /**
         * WordPress dependencies
         */
        ...
        function getSaveElement(blockTypeOrName, attributes, innerBlocks = []) {
            ...
            if (
                ...
                if (
                    !external_wp_isShallowEqual_default()(props, element.props)
                ) {
                    element = (0,
                    external_wp_element_namespaceObject.cloneElement)(
                        element,
                        props
                    );
                }
        ...
        function __unstableSerializeAndClean(blocks) {
            ...
            if (
                ...
                content = (0, external_wp_autop_namespaceObject.removep)(
                    content
                );
            }
            return content;
                        ...
                        if (isSpace(char)) {
                            ...
                            var nextSixChars =
                                ...
                                this.input
                                    ...
                                    .toUpperCase();
                            var isPublic =
                                nextSixChars.toUpperCase() === "PUBLIC";
                            var isSystem =
                                nextSixChars.toUpperCase() === "SYSTEM";
        ...
        var Tokenizer = /** @class */ (function() {
            ...
            Tokenizer.prototype.appendToDoctypePublicIdentifier = function(
                char
            ) {
            ...
            Tokenizer.prototype.appendToDoctypeSystemIdentifier = function(
                char
            ) {
                var doctype = this.current("Doctype" /* Doctype */);
        ...
        function tokenize(input, options) {
            var tokenizer = new Tokenizer(
                new EntityParser(namedCharRefs),
                options
            );
        ...
        function fixCustomClassname(blockAttributes, blockType, innerHTML) {
            ...
            const serialized = getSaveContent(
                blockType,
                attributesSansClassName
            );
            ...
            while (decu.firstChild) {
                ...
                if (node.nodeType === node.TEXT_NODE) {
                    ...
                    if (node.nodeName === "BR") {
                        ...
                        if (
                            (0, external_wp_dom_namespaceObject.isEmpty)(
                                node
                            ) &&
                            !options.raw
                        ) {
                        ...
                        (0, external_wp_dom_namespaceObject.isPhrasingContent)(
                            node
                        )
                    ) {
                        if (
        ...
        function specialCommentConverter(node, doc) {
            ...
            if (!node.parentNode || node.parentNode.nodeName !== "P") {
                ...
                [
                    ...
                    element =>
                        element &&
                        wrapperNode.insertBefore(element, node.parentNode)
                );
        ...
        function canHaveAnchor(node, schema) {
            ...
            return (
                ...
                ((_schema$figure$childr2 =
                    schema?.figure?.children?.a?.children) !== null &&
        ...
        function segmentHTMLToShortcodeBlock(
            ...
            const transformation = findTransform(
                ...
                transform =>
                    ...
                    castArray(transform.tag).some(tag =>
                        (0, external_wp_shortcode_namespaceObject.regexp)(
                            tag
                        ).test(HTML)
                    )
            );
            ...
            const transformTag = transformTags.find(tag =>
                (0, external_wp_shortcode_namespaceObject.regexp)(tag).test(
                    HTML
                )
            );
            let match;
        ...
        /* harmony default export */ const shortcode_converter = segmentHTMLToShortcodeBlock; // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js
        ...
        function getBlockContentSchemaFromTransforms(transforms, context) {
            ...
            const schemas = transforms.map(({ isMatch, blockName, schema }) => {
                ...
                schema =
                    typeof schema === "function" ? schema(schemaArgs) : schema;
        ...
        function getBlockContentSchema(context) {
            return getBlockContentSchemaFromTransforms(
                getRawTransforms(),
                context
            );
        }
        ...
        function deprecatedGetPhrasingContentSchema(context) {
            external_wp_deprecated_default()(
                "wp.blocks.getPhrasingContentSchema",
                {
                    since: "5.6",
        ...
        function phrasingContentReducer(node, doc) {
            ...
            if (node.nodeName === "SPAN" && node.style) {
                ...
                node = (0, external_wp_dom_namespaceObject.replaceTag)(
                    node,
                    "strong"
                );
        ...
        function imageCorrector(node) {
            ...
            if (node.src.indexOf("data:") === 0) {
                ...
                node.src = (0, external_wp_blob_namespaceObject.createBlobURL)(
                    file
                );
            }
        ...
        function filterInlineHTML(HTML) {
            ...
            HTML = (0, external_wp_dom_namespaceObject.removeInvalidHTML)(
                HTML,
                (0, external_wp_dom_namespaceObject.getPhrasingContentSchema)(
                    "paste"
                ),
                {
                    inline: true
        ...
        function pasteHandler({
            ...
            const blocks = pieces
                .map(piece => {
                    ...
                    piece = deepFilterHTML(piece, filters, blockContentSchema);
                    piece = (0,
                    external_wp_dom_namespaceObject.removeInvalidHTML)(
                        piece,
                        schema
                    );
                    piece = normaliseBlocks(piece);
                ...
                ([name, attributes, innerBlocksTemplate], index) => {
                    ...
                    const normalizedAttributes = normalizeAttributes(
                        (_blockType$attributes = blockType?.attributes) !==
                            null && _blockType$attributes !== void 0
                            ? _blockType$attributes
                            : {},
                        attributes
                    );
        ...
        function withBlockContentContext(OriginalComponent) {
            external_wp_deprecated_default()(
                "wp.blocks.withBlockContentContext",
                {
                    since: "6.1"
                }
            );
