                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane">
                                    <form class="form-horizontal" method="post" action="{{ route('saveJob')}}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-3 col-form-label">Job Title</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="job_category" value="" class="form-control"
                                                    id="" placeholder="Job Title">
                                                @error('job_category')
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-3 col-form-label"> Number Of Vacancies
                                                *</label>
                                            <div class="col-sm-7">
                                                <input type="text" name="number_of_vacancies" value=""
                                                    class="form-control" id="" placeholder="Number Of Vacancies">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 pt-2">
                                        <input type="checkbox" class="form-check-label" name="employee_status[]"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" name="application_deadline"
