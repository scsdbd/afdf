            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="{{ route('storenotice')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-3 col-form-label">Notice</label>
                                    <div class="col-sm-9">
                               
                               <input type="text" name="title" id="input" class="form-control" value="" placeholder="Title" title="">
