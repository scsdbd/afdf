...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">All Refund Policies</h5>
                </div>
            </div>
        </div>
        <hr class="style18">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-cyan">
                            <h3 class="card-title"> <i class="fa fa-users"></i> All Refund Policies</h3>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Refund Policy</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="editForm" method="POST" action="{{ route('return-policy.edit', $value->id) }}">
                @csrf
                @method('PUT')

                <input type="hidden" name="id" id="returnPolicyId" />
...
<script>
    ...
    $('#editModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-body #returnPolicyId').val(id); // Set the ID for the hidden input
