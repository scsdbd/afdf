...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">Edit Zone</h5>
                </div><!-- /.col -->
                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header bg-cyan">
                            <h3 class="card-title"> <i class="fas fa-edit"></i> Edit zone</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{route('updatezone',$zoneedit->id)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        ...
                                        <select class="form-control" name="divisions" id="division">
                                            ...
                                            <option {{ $zoneedit->division == $each->id ? 'selected' : ''  }} value="{{ $each->id }}">{{ $each->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('district')
