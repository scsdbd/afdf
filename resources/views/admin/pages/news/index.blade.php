...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">All news</h5>
                </div><!-- /.col -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-cyan">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title"> <i class="fa fa-users"></i> All news</h3>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{route('create.news')}}" class="btn btn-success float-right"> <i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('news.delete',$value->id)}}"
