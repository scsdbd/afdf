    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-blue text-center"> EDIT news</div>
                        <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="number" id="order_by" name="order_by" value="{{$news->oderby ?? ''}}" class="form-control">
                                                @error('order_by')
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="name"
                                                    value="{{$news->name ?? ''}}" class="form-control">
                                                @error('name')
                                                <div class="error text-red text-bold" style="padding: 0;">
                                                    <strong>
                                                        {{$message}}
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                @if($news->image)
                                                <img src="{{asset($news->image)}}" alt="" width="30%">
                                                @endif
                                                @error('image')
                                                <div class="error text-red text-bold" style="padding: 0;">
                                                    <strong>
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" id="meta" name="meta" value="{{$news->meta ?? ''}}" class="form-control">
                                                @error('meta')
