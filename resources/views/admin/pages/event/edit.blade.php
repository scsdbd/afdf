    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-blue text-center"> EDIT Event</div>
                        <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="number" id="order_by" name="order_by" value="{{$event->oderby ?? ''}}" class="form-control">
                                                @error('order_by')
                                                <div class="error text-red text-bold" style="padding: 0;">
                                                    <strong>
                                                        {{$message}}
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                @if($event->image)
                                                <img src="{{asset($event->image)}}" alt="" width="30%">
                                                @endif
                                                @error('image')
                                                <div class="error text-red text-bold" style="padding: 0;">
                                                    <strong>
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" id="meta" name="meta" value="{{$event->meta ?? ''}}" class="form-control">
                                                @error('meta')
