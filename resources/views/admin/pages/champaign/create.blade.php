    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-blue text-center"> ADD champaign</div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane">
                                    <form class="form-horizontal" method="post"
                                        action="{{Route('champaign.store')}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="type" id="type" style="margin-bottom: 10px;border-radius: 5px;" class="form-control">
                                                    ...
                                                    <option value="current">Current champaign</option>
                                                    <option value="complite">Compited champaign</option>
                                                </select>
                                                @error('type')
