...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">Add New District</h5>
                </div><!-- /.col -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-info btn-xs float-right" data-toggle="modal"
                                data-target="#myModal">+ New District</button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="color:white" type="button" class="btn btn-info btn-xs"
                                                ...
                                                <i style="color:white"
                                                    onclick="getData('<?php echo $item->id; ?>','<?php echo $item->division_id; ?>','<?php echo $item->name; ?>','<?php echo $item->bn_name; ?>','<?php echo $item->url; ?>')"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('district_update')}}" method="POST">
                    @csrf
...
<script>
    function getData(uid,division_id, name, bn_name, url){
        $("#updateId").val(uid);
       var division_id =  $("#division_id").val(division_id);
        $("#name").val(name);
        $("#bn_name").val(bn_name);
        $("#url").val(url);
        var value = division_id.options[division_id.selectedIndex].value;
        var text = division_id.options[division_id.selectedIndex].text;
}
</script>
