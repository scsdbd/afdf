                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header bg-cyan">
                            <h3 class="card-title"> <i class="fa fa-list-alt"></i> Add Category</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{route('storemember_category')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="number" name="fee" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" name="incentive" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="number" name="annual" class="form-control" id="exampleInputEmail1"
