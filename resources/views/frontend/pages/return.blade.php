...
<section class="inner-header-title"
    ...
    <div class="container">
        <h1 style="color: white; text-shadow: 1px 1px 2px rgba(0,0,0,0.7);">Return Policy</h1>
    </div>
</section>
<div class="clearfix"></div>
<!-- Title Header End -->
...
@php
$privacy = App\Models\Privacy::where('type', 'return_policy')->get(); // Use first() instead of get() to get a single entry
@endphp
