 <section class="volunteer-section section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="{{asset('images/shapes/smiling_girl.jpg')}}"
                            class="volunteer-image img-fluid" alt="">

                        <div class="custom-block-body text-center">
                            <h4 class="text-white mt-lg-3 mb-lg-3" style="color:#fff">About Volunteering</h4>

                            <p class="text-white">We sincerely expect your active support and cooperation in our every step and initiatives for ameliorating the status of BIEA and expanding indenting help the country.”
