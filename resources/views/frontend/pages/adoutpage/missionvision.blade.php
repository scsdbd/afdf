...
<!-- ✅ ABOUT US SECTION -->
<section class="aboutus-container scroll-center" id="about-container">
    <!-- LEFT IMAGE -->
    ...
    <div class="aboutus-right">
        ...
        <div id="about-text" class="aboutus-text active">
            <p>We focus on creating opportunities that help people reach their full potential through education,
                awareness, and action.</p>
        </div>

        <div id="mission-text" class="aboutus-text">
            <p>Our mission is to build inclusive communities, empower individuals, and promote equal opportunities for
                all.</p>
        </div>
